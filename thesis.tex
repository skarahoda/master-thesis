...
\begin{figure}[ht]
	\centering
	\subfigure[$n = 2000$]{
		\includegraphics[width=0.55\textwidth]{figs/node_2000.png}
	}
	\subfigure[$n = 4000$]{
		\includegraphics[width=0.55\textwidth]{figs/node_4000.png}
	}
	\subfigure[$n = 8000$]{
		\includegraphics[width=0.55\textwidth]{figs/node_8000.png}
	}
...
\begin{figure}[ht]
	\centering
	\subfigure[$p = 2$]{
		\includegraphics[width=0.38\textwidth]{figs/p2_greedy.png}
	}
	\subfigure[$p = 8$]{
		\includegraphics[width=0.38\textwidth]{figs/p8_greedy.png}
	}
	\subfigure[$p = 32$]{
		\includegraphics[width=0.38\textwidth]{figs/p32_greedy.png}
	}
	\subfigure[$p = 128$]{
		\includegraphics[width=0.38\textwidth]{figs/p128_greedy.png}
	}
