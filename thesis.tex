...
The rest of the paper is organized as follows: In Section~\ref{sec:Preliminaries}, the notation is given, and synchronizing sequences are formally defined. We give the details of Eppstein's {\sc Greedy} construction algorithm in Section \ref{sec:greedy}. The parallelization approach together with implementation details are described in Section \ref{sec:parallel}.
